...
window.onload = function () {
  ...
  function parallax(e) {
    this.querySelectorAll('.parallax__img').forEach(function (layer) {
  ...
  $("form").submit(function (e) {
    ...
    var modalSent = document.getElementById("modal-sent");
    var spanClose = document.getElementsByClassName("sent__close")[0];
    ...
    window.onclick = function (event) {
      if (event.target == modalSent) {
        modalSent.style.display = "none"; // location.reload(true);
      }
    };
  });
}();